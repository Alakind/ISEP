...
import ut.isep.management.service.assignment.GitHubAssignmentReadService
import java.util.NoSuchElementException

@RestController
@RequestMapping("/github/assignment")
@Tag(name = "Assignment")
class GitHubAssignmentController(val gitHubAssignmentReadService: GitHubAssignmentReadService) {
    ...
    fun getAssignmentById(@PathVariable id: Long): ResponseEntity<AssignmentReadDTO> {
        return try {
            return ResponseEntity.ok(gitHubAssignmentReadService.getById(id))
