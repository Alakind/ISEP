...
import {AssessmentInterface, AssignmentInterface, PreInfoInterface, TestResultsInterface} from "./types";
import {Languages} from "./constants";

const baseUrl = import.meta.env.VITE_API_APPLICANT_URL;

export async function sendSimpleSolution(assignment: AssignmentInterface, answer: (string | string[])): Promise<void> {
...
export async function runTests(language: (typeof Languages)[keyof typeof Languages], inviteId: string, code: string, test: string): Promise<Array<TestResultsInterface>> {
