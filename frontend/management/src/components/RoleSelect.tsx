    ...
    <span className="role-select">
      {
        disabled ?
          ...
          <select id={`role-select_${id}`} onChange={(e: ChangeEvent<HTMLSelectElement>): void => handleSelect(e)} className="role-select__select" defaultValue={selectedOption ? selectedOption.toString() : ""}>
