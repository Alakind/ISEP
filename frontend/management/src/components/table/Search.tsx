  ...
  return (
    <div className="user-list__div">
      <form className="form-inline user-list__form">
        <input id="search" value={query} onChange={(e: ChangeEvent<HTMLInputElement>): void => setQuery(e.target.value)} className="form-control mr-sm-2 input--mod" type="text" placeholder="Search..." aria-label="Search" />
